...
class MainWindow:
    def __init__(self, project_manager, node_factory, groups, config=None):
    ...
    def _setup_ui(self):
        ...
        with dpg.file_dialog(
            tag="open_editor_dialog", show=False, width=700, height=400,
        ...
        with dpg.viewport_menu_bar():
            with dpg.menu(label="File"):
                ...
                dpg.add_menu_item(label="Open...", callback=lambda: dpg.show_item("open_editor_dialog"))
